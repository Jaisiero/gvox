...
#define GVOX_CHANNEL_ID_DENSITY 10
#define GVOX_CHANNEL_ID_PHASE 11
#define GVOX_CHANNEL_ID_LAST_STANDARD 23
#define GVOX_CHANNEL_ID_MATERIAL_TYPE 24
...
#define GVOX_CHANNEL_BIT_DENSITY (1 << GVOX_CHANNEL_ID_DENSITY)
#define GVOX_CHANNEL_BIT_PHASE (1 << GVOX_CHANNEL_ID_PHASE)
#define GVOX_CHANNEL_BIT_LAST_STANDARD (1 << GVOX_CHANNEL_ID_LAST_STANDARD)
#define GVOX_CHANNEL_BIT_MATERIAL_TYPE (1 << GVOX_CHANNEL_ID_MATERIAL_TYPE)
