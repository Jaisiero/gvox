...
GVOX_ENUM(GvoxAttributeType){
    ...
    GVOX_ATTRIBUTE_TYPE_METALNESS,
    GVOX_ATTRIBUTE_TYPE_IOR,
    GVOX_ATTRIBUTE_TYPE_REFLECTIVITY,
    GVOX_ATTRIBUTE_TYPE_EMISSIVITY,
    GVOX_ATTRIBUTE_TYPE_DENSITY,
    GVOX_ATTRIBUTE_TYPE_PHASE,
